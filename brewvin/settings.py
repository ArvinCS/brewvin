"""
Django settings for brewvin project.
...
SECRET_KEY = 'django-insecure-l!xj&a1$@6f2%tsi36v_1djen#70#hkeumwdt#b7rlv*gdkw6$'
...
WSGI_APPLICATION = 'brewvin.wsgi.application'
